...
void SumWindow::paintEvent(QPaintEvent *)
{
    QPixmap back_icon;
...
void SumWindow::mouseMoveEvent(QMouseEvent *event)
{
    QPoint EndPos;
...
void SumWindow::mousePressEvent(QMouseEvent *event)
{
    if(event->buttons()==Qt::LeftButton)
    {
...
bool SumWindow::eventFilter(QObject *target,QEvent *event)
{
    if(target == this->daan)
    {
...
void SumWindow::getRandomNumber()
{
